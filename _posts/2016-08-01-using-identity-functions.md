...
{% include responsive_image.html name="identity" alt="The left hands side of the equation f(x) is followed by a fingerprint representing identity on the right hand side of the equation" width="720" height="555" %}
